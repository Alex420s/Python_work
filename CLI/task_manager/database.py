...
def insert_todo(todo: Todo):
    ...
    with conn:
        c.execute('INSERT INTO todos VALUES (:task, :category, :description, :date_added, :date_completed, :status, :position)',
        {'task': todo.task, 'category': todo.category, 'description': todo.description, 'date_added': todo.date_added,
...
def update_todo(position: int, task: str, category: str, description: str):
    with conn:
